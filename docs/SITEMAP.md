# 🗺️ 열고닫기 (OPCL) 사이트맵 (2026.04.21 업데이트)

> **문서 목적:** 서비스의 전체 경로 구조(Site Map)와 각 페이지별 역할을 매핑하여 시스템의 네비게이션 체계를 파악하는 데 목적이 있습니다.
...
- [사내 문서 센터](http://localhost:3000/docs) : 기술 문서 및 보안 점검 보고서 관리 전용 센터
