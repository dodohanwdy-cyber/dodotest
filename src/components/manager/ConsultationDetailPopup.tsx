...
const EXAMPLE_AI_ANALYSIS = {
  chat_summary:
    "내담자는 최근 권고사직 이후\n월세 체납이 발생하여 주거 지원이 절실한 상황입니다.\n초기에는 대화에 소극적이었으나 지원 정책 안내 이후\n구체적인 향후 계획에 대해 의지를 보였습니다.\n현재 심리적으로 매우 위축되어 있어\n즉각적인 생활 안정 지원이 병행되어야 합니다.",
  special_notes:
    "불면 증세 언급 있음.\n정신건강복지센터와의 연계도 함께 고려 필요.\n실직 후 6개월 경과, 긴급복지지원 신청 기간 내에 있음.",
  consultation_guide:
    "1. 먼저 현재 가장 급한 생활비·주거 문제를 파악하세요.\n2. 긴급복지지원 제도의 지급 가능 항목을 안내하세요.\n3. 취업 의지 확인 후 국민취업지원제도 연계를 제안하세요.\n4. 정서적 어려움이 있으면 상담 센터 연계를 권장하세요.",
  policy_roadmap: [
    {
      제목: "1단계 · 긴급 생활 안정",
...
export default function ConsultationDetailPopup({
  ...
  const LOADING_MESSAGES = [
    ...
    "📚 전국 1,000여 개의\n청년정책 DB를 탐색 중입니다...",
    "💡 나이, 지역(울산), 직업 조건에 맞는\n상위 15개 정책을 필터링했습니다!",
    "✍️ 전문 상담사 페르소나를 씌워\nAI가 맞춤형 가이드를 작성 중입니다...",
    "✨ 거의 다 되었습니다.\n최종 리포트를 보기 좋게 정리하고 있습니다..."
  ];
