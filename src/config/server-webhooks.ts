export const SERVER_WEBHOOK_URLS: Record<string, string> = {
  ...
  GET_PREVIEW_DETAIL: "https://primary-production-1f39e.up.railway.app/webhook/send-preview-data", 
  ...
  REQUEST_READJUSTMENT: "https://primary-production-1f39e.up.railway.app/webhook/request-readjustment",
  RESET_SCHEDULE: "https://primary-production-1f39e.up.railway.app/webhook/reset-schedule",
