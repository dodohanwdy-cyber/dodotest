...
export const WEBHOOK_URLS = {
  // 1단계: 인증 및 기본 정보
  LOGIN: "https://primary-production-1f39e.up.railway.app/webhook/login-id", // 로그인 처리 및 사용자 정보 조회
  SIGNUP: "https://primary-production-1f39e.up.railway.app/webhook/signup", // 회원가입 및 초기 데이터 생성
  UPDATE_USER: "https://primary-production-1f39e.up.railway.app/webhook/update-user", // 사용자 정보 수정

  // 2단계: 상담 신청 (아코디언 워크플로우)
  SUBMIT_INTAKE: "https://primary-production-1f39e.up.railway.app/webhook/submit-intake", // [Section 1] 상담 정보 입력 저장
  GET_CALENDAR: "https://primary-production-1f39e.up.railway.app/webhook/time-check", // [Section 2] 예약 가능한 일정 조회
  ...
  GENERATE_NOTION_REPORT: "https://primary-production-1f39e.up.railway.app/webhook/notion-report", // [신규] 노션 공유용 리포트 생성
};
