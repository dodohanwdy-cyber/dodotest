      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 sm:gap-6">
        <div className="space-y-1 w-full md:w-auto">
          <div className="flex items-center justify-between md:justify-start gap-2 sm:gap-3">
            <div className="flex items-center gap-2 sm:gap-3">
              <Link href="/manager/dashboard" className="p-1.5 sm:p-2 hover:bg-slate-100 rounded-full transition-colors text-slate-400">
                <ChevronLeft size={20} className="sm:w-6 sm:h-6" />
              </Link>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">상담 완료 내역</h1>
            </div>
            <div className="md:hidden">
              <UITagBadge id="P-104" label="완료된 상담 내역" />
            </div>
          </div>
          <p className="text-xs sm:text-sm text-slate-500 ml-8 sm:ml-11">과거에 완료된 모든 상담 기록을 확인하고 관리할 수 있습니다.</p>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full md:w-auto shrink-0">
          <button
            ...
            disabled={isLoading}
            className="flex-none flex items-center gap-1.5 px-3.5 sm:px-4 py-2.5 sm:py-3 bg-white text-slate-600 font-bold border border-slate-200 rounded-xl sm:rounded-2xl hover:bg-slate-50 disabled:opacity-50 transition-all shadow-sm text-xs sm:text-sm whitespace-nowrap"
            title="분석 상태 다시 불러오기"
          >
          ...
          <div className="relative flex-1 md:w-80">
            ...
            <input 
              ...
              className="w-full pl-9 pr-3.5 py-2.5 sm:py-3 bg-white border border-slate-200 rounded-xl sm:rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-xs sm:text-sm shadow-sm"
            />
          </div>
        </div>
      </div>
